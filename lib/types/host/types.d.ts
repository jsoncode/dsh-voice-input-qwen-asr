...
export declare const OVERRIDABLE_KEYS: readonly ["installDir", "runtimeDir", "modelDir", "pythonPath", "asrPort", "language", "pipIndexUrl", "partialIntervalMs", "maxAudioSeconds", "device"];
