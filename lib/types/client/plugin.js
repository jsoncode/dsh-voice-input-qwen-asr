...
export function createPlugin() {
    return {
        ...
        apply(ctx) {
            ...
            slots.inject('conversation.input.right', () => slots.register({ name: 'conversation.input.right', id: 'dsh-voice-input-qwen-asr-mic', order: 20, label: () => t('micLabel') }, VoiceButton));
            // 设置页「语音识别」
